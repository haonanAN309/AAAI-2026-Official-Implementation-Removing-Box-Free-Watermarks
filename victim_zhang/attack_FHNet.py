...
def save_result_pic(this_batch_size,  originalLabelvA, originalLabelvB, Container_allImg, uncover_img, secretLabelv, RevSecImg,
    ...
    originalLabelvA = originalLabelvA.resize_(this_batch_size, 3, 256, 256)
    ...
    showResult = torch.cat(
        [originalLabelvA, originalFramesB,  container_allFrames, uncoverFrames, secretFrames,
...
with torch.no_grad():
    ...
    secret_img = Image.open("secret/flower.png").convert("RGB")  # 256 * 256
